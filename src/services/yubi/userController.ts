...
/** updateOrAddUser POST /api/user/update/or/add */
export async function updateOrAddUserUsingPost(body: API.User, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean_>('/api/user/update/or/add', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
